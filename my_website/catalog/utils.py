class CatalogContextMixin:
    """
    Миксин для классов представлений приложения "catalog".

    Как использовать:
      - Наследовать миксин ПЕРВЫМ: class SomeView(CatalogContextMixin, DetailView)
      - В классе при необходимости задать `page_title`.
